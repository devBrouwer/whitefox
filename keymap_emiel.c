...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------|
     * | FN2  |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Enter   |PgU| 12k, 2k
     * |---------------------------------------------------------------| 
     * |  FN3   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift |Up |FN2| 1k, 13k
     * |---------------------------------------------------------------|
     * |Ctl |Gui |Alt |         Space         |Alt |FN2 |_|Lef|Dow|Rig| 6k, 3k
     * `---------------------------------------------------------------'
     */
    [0] = KEYMAP( \
        ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,GRV, INS,\
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSPC,     DEL,\
        FN2,  A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,ENT,     MPLY,\
        FN3,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,RSFT,     UP,  FN2,\
        LCTL,LGUI,LALT,               SPC,           RALT,FN2,     LEFT,DOWN,RGHT \
    ),
	//----------------------------------------------------------------------------------------
    ...
    [2] = KEYMAP( \
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,    PGUP,FN1, \
